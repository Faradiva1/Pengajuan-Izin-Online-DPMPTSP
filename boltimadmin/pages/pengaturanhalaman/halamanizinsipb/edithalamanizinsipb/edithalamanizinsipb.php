                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            if (isset($_GET['iduser'])) {
                                $edit_id = $_GET['iduser'];
                                $query = "SELECT * FROM izin_sipb WHERE id='$edit_id'"; // Sesuaikan dengan tabel Anda
                                $result = mysqli_query($conn, $query);
                                $row = mysqli_fetch_assoc($result);
                            }
                            ?>

                            <form action="?q=edithalamanizinsipb&iduser=<?= $edit_id; ?>&id=<?php echo $idadmin; ?>" method="post" enctype="multipart/form-data">
