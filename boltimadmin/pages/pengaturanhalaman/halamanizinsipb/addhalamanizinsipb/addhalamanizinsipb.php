...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO izin_sipb (judul, judul_dua, deskripsi, gambar, tanggal_dibuat, tanggal_diperbarui) 
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="?q=addhalamanizinsipb&id=<?= $id; ?>" method="POST" enctype="multipart/form-data">
                                <div class="mb-3">
