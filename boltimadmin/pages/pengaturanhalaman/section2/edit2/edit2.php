...
if (isset($_GET['iduser'])) {
    ...
    $query = mysqli_query($conn, "SELECT * FROM informasi_simpati WHERE id = '$id'");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $updateQuery = mysqli_query($conn, "UPDATE informasi_simpati SET judul = '$judul', deskripsi = '$deskripsi' WHERE id = '$id'");
    if ($updateQuery) {
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            $edit_id = $_GET['iduser'];
                            $query = "SELECT * FROM informasi_simpati WHERE id='$edit_id'"; // Sesuaikan dengan tabel Anda
                            $result = mysqli_query($conn, $query);
                            $row = mysqli_fetch_assoc($result);
                            ?>

                            <form action="?q=edit2&iduser=<?= $edit_id; ?>&id=<?php echo $idadmin; ?>" method="post" enctype="multipart/form-data">
