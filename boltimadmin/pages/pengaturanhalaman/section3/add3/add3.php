...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO informasi_section_tiga (judul, deskripsi, checklist_1, checklist_2, 
                            checklist_3, checklist_4, checklist_5, checklist_6, checklist_7, checklist_8, 
                            checklist_9, checklist_10, checklist_11, gambar_url) VALUES ('$judul', '$deskripsi',
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="?q=add3&id=<?= $id; ?>" method="POST" enctype="multipart/form-data">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="checklist_8" name="checklist_8" required>
                                </div>
                                <div class="mb-3">
                                    <label for="checklist_9" class="form-label">Checklist 9</label>
                                    <input type="text" class="form-control" id="checklist_9" name="checklist_9" required>
                                </div>
                                <div class="mb-3">
                                    <label for="checklist_10" class="form-label">Checklist 10</label>
                                    <input type="text" class="form-control" id="checklist_10" name="checklist_10" required>
                                </div>
                                <div class="mb-3">
                                    <label for="checklist_11" class="form-label">Checklist 11</label>
                                    <input type="text" class="form-control" id="checklist_11" name="checklist_11" required>
                                </div>
