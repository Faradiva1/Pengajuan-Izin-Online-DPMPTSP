...
if (isset($_GET['iduser'])) {
    ...
    $query = mysqli_query($conn, "SELECT * FROM informasi_section_tiga WHERE id = '$id'");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $checklist_8 = $_POST['checklist_8'];
    $checklist_9 = $_POST['checklist_9'];
    $checklist_10 = $_POST['checklist_10'];
    $checklist_11 = $_POST['checklist_11'];
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $query = mysqli_query($conn, "UPDATE informasi_section_tiga SET judul = '$judul', deskripsi = '$deskripsi', 
                ...
                checklist_7 = '$checklist_7', checklist_8 = '$checklist_8', checklist_9 = '$checklist_9', 
                checklist_10 = '$checklist_10', checklist_11 = '$checklist_11' WHERE id = '$id'");
        if ($query) {
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            $edit_id = $_GET['iduser'];
                            $query = "SELECT * FROM informasi_section_tiga WHERE id = '$edit_id'"; // Sesuaikan dengan tabel Anda
                            $result = mysqli_query($conn, $query);
                            $row = mysqli_fetch_assoc($result);
                            ?>

                            <form action="?q=edit3&iduser=<?= $edit_id; ?>&id=<?php echo $idadmin; ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <label for="checklist_8" class="form-label">Checklist 8</label>
                                    <input type="text" class="form-control" id="checklist_8" name="checklist_8" value="<?php echo $row['checklist_8']; ?>" required>
                                </div>
                                <div class="mb-3">
                                    <label for="checklist_9" class="form-label">Checklist 9</label>
                                    <input type="text" class="form-control" id="checklist_9" name="checklist_9" value="<?php echo $row['checklist_9']; ?>" required>
                                </div>
                                <div class="mb-3">
                                    <label for="checklist_10" class="form-label">Checklist 10</label>
                                    <input type="text" class="form-control" id="checklist_10" name="checklist_10" value="<?php echo $row['checklist_10']; ?>" required>
                                </div>
                                <div class="mb-3">
                                    <label for="checklist_11" class="form-label">Checklist 11</label>
                                    <input type="text" class="form-control" id="checklist_11" name="checklist_11" value="<?php echo $row['checklist_11']; ?>" required>
                                </div>
